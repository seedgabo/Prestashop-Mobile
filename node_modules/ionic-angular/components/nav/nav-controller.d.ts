import { ViewContainerRef, DynamicComponentLoader, ResolvedReflectiveProvider, ElementRef, NgZone, Renderer, Type, EventEmitter } from '@angular/core';
...
export declare class NavController extends Ion {
     ...
     */
    isPortal: boolean;
    constructor(parent: any, _app: App, config: Config, _keyboard: Keyboard, elementRef: ElementRef, _zone: NgZone, _renderer: Renderer, _loader: DynamicComponentLoader);
    /**
     * @private
     */
