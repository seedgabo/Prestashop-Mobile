...
export declare class Tab extends NavController {
    ...
    constructor(parentTabs: Tabs, app: App, config: Config, keyboard: Keyboard, elementRef: ElementRef, zone: NgZone, renderer: Renderer, loader: DynamicComponentLoader, _cd: ChangeDetectorRef);
    /**
     * @private
     */
